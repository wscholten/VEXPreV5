...
#pragma config(Motor,  port6,           leftShooter,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           rightShooter,  tmotorVex393_MC29, openLoop)
...
task shooter()
{
	while(1 == 1)
	{
		...
		{
			motor[leftShooter] = 127;    	//Spin up shooter
			motor[rightShooter] = 127;
		}
		else
		{
			motor[leftShooter] = 0;   	//...stop shooter
